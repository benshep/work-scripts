...
def read_excel(excel_filename: Path, func: Callable = pandas.read_excel, **kwargs):
    ...
    result = func(temp_filename, **kwargs)
...
class StoredData:
    ...
    def __init__(self, filename: Path, **read_excel_kwargs):
